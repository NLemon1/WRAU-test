(function uMarketingSuite_GA4_bridge() {
    ...
    function bridgeGA4ToUms(originalReturn, arguments) {
        ...
        window.ums("send", "event", category, eventName);
    ...
    if (window.navigator != null &&
        ...
        window.navigator.sendBeacon = function sendBeacon_uMarketingSuite_GA4_bridge() {
            ...
            return bridgeGA4ToUms(originalReturn, arguments);
        }
    }
    ...
    window.fetch = function() {
        // Call original Fetch and bridge the event to UMS
