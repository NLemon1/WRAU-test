...
//     private MemberSubscriptionServiceSettings _settings;
//     ServiceBusProcessor _processor;
//     readonly ILogger<WraMemberSubscriptionService> _logger;
//
//     public WraMemberSubscriptionService(SubscriptionServiceSettings settings, ILogger<WraMemberSubscriptionService> logger)
//     {
//         _settings = settings?.MemberSubscriptionServiceSettings ?? throw new ArgumentException("Failed to load settings");
//         _topicName = _settings.TopicName;
//         _subscriptionName = _settings.SubscriptionName;
//         _connectionString = _settings.SubscriptionEndpoint;
