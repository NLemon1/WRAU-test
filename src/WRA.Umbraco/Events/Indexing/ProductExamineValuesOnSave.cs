...
{
    public class ProductExamineValuesOnSave : INotificationHandler<ContentCacheRefresherNotification>
    {
        private readonly IExamineManager _examineManager;
        private readonly IUmbracoContextFactory _umbracoContextFactory;
        public ProductExamineValuesOnSave(IExamineManager examineManager,
